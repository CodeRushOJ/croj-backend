...
assert_equal "9" "$(mysql_query "$concurrent_database" \
    "SELECT COUNT(*) FROM flyway_schema_history WHERE success = 1 AND version IS NOT NULL")" \
    "concurrent startup did not apply V1-V9 exactly once"
